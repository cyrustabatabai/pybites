...
def create_parser():
    ...
    ap = argparse.ArgumentParser("Calculate your BMI")

    ap.add_argument("--weight",'-w',help='Your weight in kg',type=float)
    ap.add_argument("--length",'-l',help='Your length in cm',type=float)
    return ap
